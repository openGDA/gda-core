...
public class FitPoly{
	...
	/**
	 * Use the Least Squares fit method for fitting a polynomial to 2-D data for measurements y[i] vs. dependent
	 * variable x[i]. This fit assumes there are errors only on the y measuresments as given by the sigma_y array.<br>
	 * <br>
	 * See, e.g. Press et al., "Numerical Recipes..." for details of the algorithm. <br>
	 * <br>
	 ...
	 * @param num_points -
	 *            number of points to fit. Less than or equal to the dimension of the x array.
	 */
	public static void fit(double[] parameters, double[] x, double[] y, double[] sigma_y,
			int num_points) {
		...
		try {
			...
			logger.debug("QRD solve failed: " + e);
			return;
		}
