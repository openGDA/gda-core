 ...
 */
public class CopyOfMinpackExample {
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		...
		function.getFunction("Gaussian1").getParameter("area").setLowerLimit(0.0);
		function.getFunction("Gaussian1").getParameter("area").setUpperLimit(6.0);
		function.getFunction("Gaussian1").getParameter("position").setLowerLimit(0.0);
		function.getFunction("Gaussian1").getParameter("position").setUpperLimit(6.0);
		function.getFunction("Gaussian1").getParameter("sigma").setLowerLimit(0.0);
		function.getFunction("Gaussian1").getParameter("sigma").setUpperLimit(6.0);

		function.addFunction("Gaussian2", new Gaussian1D(1.0, 1.0, 1.0));
		// Set the upper and lower bounds on the parameters
		function.getFunction("Gaussian2").getParameter("area").setLowerLimit(0.0);
		function.getFunction("Gaussian2").getParameter("area").setUpperLimit(6.0);
		function.getFunction("Gaussian2").getParameter("position").setLowerLimit(0.0);
		function.getFunction("Gaussian2").getParameter("position").setUpperLimit(6.0);
		function.getFunction("Gaussian2").getParameter("sigma").setLowerLimit(0.0);
