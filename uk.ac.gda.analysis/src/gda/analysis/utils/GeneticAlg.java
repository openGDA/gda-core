 ...
 * @deprecated use {@link uk.ac.diamond.scisoft.analysis.optimize.GeneticAlg}
 */
@Deprecated
public class GeneticAlg implements IOptimizer {
	...
	@Override
	public void Optimize(final DoubleDataset[] coords, final DoubleDataset yAxis, final IFunction function) {
		try {
