...
public final class Precision {
	...
	private static int computeRadix() {
		...
		double b = 1.0d;
		while (computeRadix == 0) {
			b += b;
			tmp1 = a + b;
			computeRadix = (int) (tmp1 - a);
		}
		return computeRadix;
	}
	...
	private static double computeMachinePrecision() {
		...
		double computeMachinePrecision = 1.0d;
		double tmp = 1.0d + computeMachinePrecision;
		while (tmp - 1.0d != 0.0d) {
			computeMachinePrecision *= inverseRadix;
			tmp = 1.0d + computeMachinePrecision;
		}
		return computeMachinePrecision;
	}
