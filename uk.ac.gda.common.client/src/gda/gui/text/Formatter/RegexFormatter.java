...
/*
 * Copyright (c) 1998 Sun Microsystems, Inc. All Rights Reserved. Sun grants you ("Licensee") a non-exclusive, royalty
 * free, license to use, modify and redistribute this software in source and binary code form, provided that i) this
 * copyright notice and license appear on all copies of the software; and ii) Licensee does not utilize the software in
 * a manner which is disparaging to Sun. This software is provided "AS IS," without a warranty of any kind. ALL EXPRESS
 * OR IMPLIED CONDITIONS, REPRESENTATIONS AND WARRANTIES, INCLUDING ANY IMPLIED WARRANTY OF MERCHANTABILITY, FITNESS FOR
 * A PARTICULAR PURPOSE OR NON-INFRINGEMENT, ARE HEREBY EXCLUDED. SUN AND ITS LICENSORS SHALL NOT BE LIABLE FOR ANY
...
class UsingRegexFormatter {
	public static void main(String[] a) {
		...
		RegexFormatter regexFor = new RegexFormatter("\\(\\d{3}\\)\\d{3}-\\d{4}");
		regexFor.setValueClass(Integer.class);
		JFormattedTextField formattedField = new JFormattedTextField(regexFor);
