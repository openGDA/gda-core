...
public final class ManualSessionBeanDescriber extends XMLBeanContentDescriber {

	@Override
	public String getBeanName() {
		return ManualSessionBean.class.getName();
	}

	@Override
	public String getEditorId() {
		return "uk.ac.gda.devices.hatsaxs.beans.ManualSessionBeanEditor";
	}
