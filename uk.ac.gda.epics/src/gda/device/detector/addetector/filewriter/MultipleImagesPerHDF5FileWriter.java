...
//		getNdFile().setFileWriteMode(FileWriteMode.STREAM);
	...
	protected NXDetectorDataAppender createFileLinkAppender() {
		...
		NXDetectorDataFileLinkAppender nxDetectorDataFileLinkAppender = new NXDetectorDataFileLinkAppender(expectedFullFileName, getxPixelSize(), getyPixelSize(), getxPixelSizeUnit(), getyPixelSizeUnit());
