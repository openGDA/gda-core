...
public class NexusDetectorProcessorTest {
	...
	public void oneTimeSetUp() throws Exception {
		...
		detector_data.addData(DETNAME, new NexusGroupData(new int[] { width, height }, sdsData).setUnsigned(), null, null);
	...
	public void testNoMergeFitter() throws Exception {
		...
		detector_data.addData(DETNAME, new NexusGroupData(new int[] { width, height }, sdsData).setUnsigned());
