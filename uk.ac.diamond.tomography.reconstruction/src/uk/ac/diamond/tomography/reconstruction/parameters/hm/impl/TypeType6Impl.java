 ...
 * <ul>
 *   <li>{@link uk.ac.diamond.tomography.reconstruction.parameters.hm.impl.TypeType6Impl#getValue <em>Value</em>}</li>
 *   <li>{@link uk.ac.diamond.tomography.reconstruction.parameters.hm.impl.TypeType6Impl#getInfo <em>Info</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeType6Impl extends EObjectImpl implements TypeType6 {
	...
	protected EClass eStaticClass() {
		return HmPackage.Literals.TYPE_TYPE6;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmPackage.TYPE_TYPE6__VALUE, oldValue, value));
	}
	...
	public void setInfo(String newInfo) {
		...
		info = newInfo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmPackage.TYPE_TYPE6__INFO, oldInfo, info));
	}
