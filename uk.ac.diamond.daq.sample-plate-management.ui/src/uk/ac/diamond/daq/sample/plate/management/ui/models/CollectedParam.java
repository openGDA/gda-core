...
import uk.ac.diamond.daq.sample.plate.management.ui.paramvalues.ParamZeroValues;

public class CollectedParam extends AbstractParam {

	public CollectedParam(String name) {
		this.name = name;
		this.paramValue = new ParamZeroValues();
	}

	public CollectedParam(String name, double value1) {
		this.name = name;
		this.paramValue = new ParamOneDoubleValue(value1);
	}

	public CollectedParam(String name, String value1) {
		this.name = name;
