...
import uk.ac.diamond.daq.sample.plate.management.ui.models.PresetParam;

public class PresetParamBuilder implements IParamBuilder {

	@Override
	public AbstractParam build(String name, Double[] values) {
		if (values.length == 1) {
			return new PresetParam(name, values[0]);
		}
