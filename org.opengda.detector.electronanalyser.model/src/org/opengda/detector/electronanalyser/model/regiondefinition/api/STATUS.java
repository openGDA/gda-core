 ...
 * <!-- end-user-doc -->
 * @see org.opengda.detector.electronanalyser.model.regiondefinition.api.RegiondefinitionPackage#getSTATUS()
 * @model
 * @generated
 */
public enum STATUS implements Enumerator {
	 ...
	 * @ordered
	 */
	READY(0, "READY", "READY"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	RUNNING(1, "RUNNING", "RUNNING"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	COMPLETED(2, "COMPLETED", "COMPLETED"), //$NON-NLS-1$ //$NON-NLS-2$
