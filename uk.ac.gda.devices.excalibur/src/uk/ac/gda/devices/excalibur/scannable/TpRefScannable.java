 ...
 *
 */
public class TpRefScannable extends BaseChipRegScannable {

	public TpRefScannable(List<ExcaliburReadoutNodeFem> fems) {
		super(fems);
	}

	@Override
	protected void doAsynchronousMoveTo(MpxiiiChipReg chipReg, int intValue) throws Exception {
		chipReg.getAnper().setTpref(intValue);
	}

	@Override
	protected Object doGetPosition() throws Exception {
		return fems.get(0).getMpxiiiChipReg1().getAnper().getTpref();
	}
}