 ...
 *
 */
public class TpRefAScannable extends BaseChipRegScannable {

	public TpRefAScannable(List<ExcaliburReadoutNodeFem> fems) {
		super(fems);
	}

	@Override
	protected void doAsynchronousMoveTo(MpxiiiChipReg chipReg, int intValue) throws Exception {
		chipReg.getAnper().setTprefA(intValue);
	}

	@Override
	protected Object doGetPosition() throws Exception {
		return fems.get(0).getMpxiiiChipReg1().getAnper().getTprefA();
	}
