 ...
 *
 */
public class TpRefBScannable extends BaseChipRegScannable {

	public TpRefBScannable(List<ExcaliburReadoutNodeFem> fems) {
		super(fems);
	}

	@Override
	protected void doAsynchronousMoveTo(MpxiiiChipReg chipReg, int intValue) throws Exception {
		chipReg.getAnper().setTprefB(intValue);
	}

	@Override
	protected Object doGetPosition() throws Exception {
		return fems.get(0).getMpxiiiChipReg1().getAnper().getTprefB();
	}
