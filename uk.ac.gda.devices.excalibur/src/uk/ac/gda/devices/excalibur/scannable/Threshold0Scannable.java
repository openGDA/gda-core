 ...
 *
 */
public class Threshold0Scannable extends BaseChipRegScannable {

	public Threshold0Scannable(List<ExcaliburReadoutNodeFem> fems) {
		super(fems);
	}

	@Override
	protected Object doGetPosition() throws Exception {
		return fems.get(0).getMpxiiiChipReg1().getAnper().getThreshold0();
	}

	@Override
	protected void doAsynchronousMoveTo(MpxiiiChipReg chipReg, int intValue) throws Exception {
		chipReg.getAnper().setThreshold0(intValue);
