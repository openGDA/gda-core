...
/**
 * Class that calculates the total number of points for some use cases of {@link IScanPointGeneratorModel} and {@link IMappingScanRegionShape}.
 ...
 * information from the {@link IScanPointGeneratorModel} is obtained which can be slow for large maps. The StatusPanel checks if the points of the
...
public class ScanPointsCalculator {
	...
	public ScanPointsCalculator(IScanPointGeneratorModel scanPathModel, IMappingScanRegionShape scanRegionShape, List<IScanPointGeneratorModel> outerScannables) {
