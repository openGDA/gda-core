...
public class PointRegionEditor extends AbstractRegionEditor {
	...
	public Composite createEditorPart(Composite parent) {
		...
		NumberAndUnitsComposite<? extends Quantity<?>> xPosition = createNumberAndUnitsComposite(composite, getXAxisName(), X_POSITION);
		...
		NumberAndUnitsComposite<? extends Quantity<?>> yPosition = createNumberAndUnitsComposite(composite, getYAxisName(), Y_POSITION);
