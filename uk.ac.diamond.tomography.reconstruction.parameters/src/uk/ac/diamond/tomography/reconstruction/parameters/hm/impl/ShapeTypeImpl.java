 ...
 * <ul>
 *   <li>{@link uk.ac.diamond.tomography.reconstruction.parameters.hm.impl.ShapeTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link uk.ac.diamond.tomography.reconstruction.parameters.hm.impl.ShapeTypeImpl#getDone <em>Done</em>}</li>
 *   <li>{@link uk.ac.diamond.tomography.reconstruction.parameters.hm.impl.ShapeTypeImpl#getInfo <em>Info</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ShapeTypeImpl extends EObjectImpl implements ShapeType {
	...
	protected EClass eStaticClass() {
		return HmPackage.Literals.SHAPE_TYPE;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmPackage.SHAPE_TYPE__VALUE, oldValue, value));
	}
	...
	public void setDone(String newDone) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmPackage.SHAPE_TYPE__DONE, oldDone, done));
	}
	...
	public void setInfo(String newInfo) {
		...
		info = newInfo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmPackage.SHAPE_TYPE__INFO, oldInfo, info));
	}
