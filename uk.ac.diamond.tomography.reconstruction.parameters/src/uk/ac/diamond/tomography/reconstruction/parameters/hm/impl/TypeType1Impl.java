 ...
 * <ul>
 *   <li>{@link uk.ac.diamond.tomography.reconstruction.parameters.hm.impl.TypeType1Impl#getValue <em>Value</em>}</li>
 *   <li>{@link uk.ac.diamond.tomography.reconstruction.parameters.hm.impl.TypeType1Impl#getInfo <em>Info</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeType1Impl extends EObjectImpl implements TypeType1 {
	...
	protected EClass eStaticClass() {
		return HmPackage.Literals.TYPE_TYPE1;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmPackage.TYPE_TYPE1__VALUE, oldValue, value));
	}
	...
	public void setInfo(String newInfo) {
		...
		info = newInfo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmPackage.TYPE_TYPE1__INFO, oldInfo, info));
	}
