 ...
 * <ul>
 *   <li>{@link uk.ac.diamond.tomography.reconstruction.parameters.hm.impl.ShapeType1Impl#getValue <em>Value</em>}</li>
 *   <li>{@link uk.ac.diamond.tomography.reconstruction.parameters.hm.impl.ShapeType1Impl#getInfo <em>Info</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ShapeType1Impl extends EObjectImpl implements ShapeType1 {
	...
	protected EClass eStaticClass() {
		return HmPackage.Literals.SHAPE_TYPE1;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmPackage.SHAPE_TYPE1__VALUE, oldValue, value));
	}
	...
	public void setInfo(String newInfo) {
		...
		info = newInfo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmPackage.SHAPE_TYPE1__INFO, oldInfo, info));
	}
