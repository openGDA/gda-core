...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>High Peaks After Columns Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link uk.ac.diamond.tomography.reconstruction.parameters.hm.impl.HighPeaksAfterColumnsTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link uk.ac.diamond.tomography.reconstruction.parameters.hm.impl.HighPeaksAfterColumnsTypeImpl#getNumberPixels <em>Number Pixels</em>}</li>
 *   <li>{@link uk.ac.diamond.tomography.reconstruction.parameters.hm.impl.HighPeaksAfterColumnsTypeImpl#getJump <em>Jump</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class HighPeaksAfterColumnsTypeImpl extends EObjectImpl implements HighPeaksAfterColumnsType {
	/**
	 ...
	 * @generated
	 */
	protected HighPeaksAfterColumnsTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return HmPackage.Literals.HIGH_PEAKS_AFTER_COLUMNS_TYPE;
	}
	...
	public NotificationChain basicSetType(TypeType10 newType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HmPackage.HIGH_PEAKS_AFTER_COLUMNS_TYPE__TYPE, oldType, newType);
	...
	public void setType(TypeType10 newType) {
		if (newType != type) {
			...
			if (type != null)
				msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - HmPackage.HIGH_PEAKS_AFTER_COLUMNS_TYPE__TYPE, null, msgs);
			if (newType != null)
				msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - HmPackage.HIGH_PEAKS_AFTER_COLUMNS_TYPE__TYPE, null, msgs);
			msgs = basicSetType(newType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmPackage.HIGH_PEAKS_AFTER_COLUMNS_TYPE__TYPE, newType, newType));
	}
	...
	public void setNumberPixels(int newNumberPixels) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmPackage.HIGH_PEAKS_AFTER_COLUMNS_TYPE__NUMBER_PIXELS, oldNumberPixels, numberPixels, !oldNumberPixelsESet));
	}
	...
	public void unsetNumberPixels() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, HmPackage.HIGH_PEAKS_AFTER_COLUMNS_TYPE__NUMBER_PIXELS, oldNumberPixels, NUMBER_PIXELS_EDEFAULT, oldNumberPixelsESet));
	}
	...
	public void setJump(BigDecimal newJump) {
		...
		jump = newJump;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmPackage.HIGH_PEAKS_AFTER_COLUMNS_TYPE__JUMP, oldJump, jump));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case HmPackage.HIGH_PEAKS_AFTER_COLUMNS_TYPE__TYPE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HmPackage.HIGH_PEAKS_AFTER_COLUMNS_TYPE__TYPE:
				return getType();
			case HmPackage.HIGH_PEAKS_AFTER_COLUMNS_TYPE__NUMBER_PIXELS:
				return getNumberPixels();
			case HmPackage.HIGH_PEAKS_AFTER_COLUMNS_TYPE__JUMP:
				return getJump();
		}
