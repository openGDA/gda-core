 ...
 * <ul>
 *   <li>{@link uk.ac.diamond.tomography.reconstruction.parameters.hm.impl.TypeType7Impl#getValue <em>Value</em>}</li>
 *   <li>{@link uk.ac.diamond.tomography.reconstruction.parameters.hm.impl.TypeType7Impl#getInfo <em>Info</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeType7Impl extends EObjectImpl implements TypeType7 {
	...
	protected EClass eStaticClass() {
		return HmPackage.Literals.TYPE_TYPE7;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmPackage.TYPE_TYPE7__VALUE, oldValue, value));
	}
	...
	public void setInfo(String newInfo) {
		...
		info = newInfo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HmPackage.TYPE_TYPE7__INFO, oldInfo, info));
	}
