...
public class ImageCalibrationHelper extends ConfigurationHelperBase {
	...
	/**
	 * Replaces the inner {@link DarkCalibrationDocument} with the one generated by the {@code builder}
	...
	private void updateScanningParameters(DarkCalibrationDocument.Builder builder) {
		getImageCalibration().setDarkCalibration(builder.build());
	}

	/**
	 * Replaces the inner {@link FlatCalibrationDocument} with the one generated by the {@code builder}
	...
	private void updateScanningParameters(FlatCalibrationDocument.Builder builder) {
		getImageCalibration().setFlatCalibration(builder.build());
	}
	...
	private ImageCalibration createImageCalibration() {
		getScanningParameters().setImageCalibration(new ImageCalibration());
