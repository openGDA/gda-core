...
/**
 * A wrapper for scan path models to allow a list of items to be edited in the GUI and optionally included in scans
 */
public interface IScanPathModelWrapper {
