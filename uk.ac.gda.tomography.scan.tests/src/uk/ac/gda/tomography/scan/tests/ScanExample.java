...
import uk.ac.gda.tomography.scan.util.ScanResourceFactoryImpl;

/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>scan</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
	...
	public static void main(String[] args) {
		...
		resourceSet
				...
				.put(Resource.Factory.Registry.DEFAULT_EXTENSION,
						new ScanResourceFactoryImpl());

		// Register the package to ensure it is available during loading.
		//
		resourceSet.getPackageRegistry().put(ScanPackage.eNS_URI,
				ScanPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI
						.createURI("http:///My.scan")); //$NON-NLS-1$
