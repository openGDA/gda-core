...
public interface IPlanFactory {
	 ...
	 */
	ITrigger addTrigger(String name, ISampleEnvironmentVariable sev, Runnable runnable, double triggerInterval);
	 ...
	 * @return reference to the created trigger
	 */
	ITrigger addTrigger(String name, ISampleEnvironmentVariable sev, Runnable runnable, double triggerSignal, double tolerance);
	 ...
	 * @return reference to the created trigger
	 */
	ITrigger addTimerTrigger(String name, Runnable runnable, long period);
