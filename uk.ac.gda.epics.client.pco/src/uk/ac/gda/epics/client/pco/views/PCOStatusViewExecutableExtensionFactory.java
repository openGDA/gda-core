 ...
 *
 */
public class PCOStatusViewExecutableExtensionFactory implements FindableExecutableExtension {
	private final Logger logger = LoggerFactory.getLogger(PCOStatusViewExecutableExtensionFactory.class);
