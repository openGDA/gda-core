 ...
 * @generated
 */
public class LdeexperimentSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case LdeexperimentPackage.EXPERIMENT_DEFINITION: {
				ExperimentDefinition experimentDefinition = (ExperimentDefinition)theEObject;
				T result = caseExperimentDefinition(experimentDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LdeexperimentPackage.SAMPLE_LIST: {
				SampleList sampleList = (SampleList)theEObject;
				T result = caseSampleList(sampleList);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LdeexperimentPackage.SAMPLE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Experiment Definition</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Experiment Definition</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseExperimentDefinition(ExperimentDefinition object) {
		return null;
	}
