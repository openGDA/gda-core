 ...
 * @generated
 */
public class LdeexperimentPackageImpl extends EPackageImpl implements LdeexperimentPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.opengda.lde.model.ldeexperiment.LdeexperimentPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private LdeexperimentPackageImpl() {
		super(eNS_URI, LdeexperimentFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link LdeexperimentPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static LdeexperimentPackage init() {
		if (isInited) return (LdeexperimentPackage)EPackage.Registry.INSTANCE.getEPackage(LdeexperimentPackage.eNS_URI);

		// Obtain or create and register package
		LdeexperimentPackageImpl theLdeexperimentPackage = (LdeexperimentPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof LdeexperimentPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new LdeexperimentPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theLdeexperimentPackage.createPackageContents();

		// Initialize created meta-data
		theLdeexperimentPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theLdeexperimentPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(LdeexperimentPackage.eNS_URI, theLdeexperimentPackage);
		return theLdeexperimentPackage;
	}
	 ...
	 * @generated
	 */
	public LdeexperimentFactory getLdeexperimentFactory() {
		return (LdeexperimentFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(sampleEClass, SAMPLE__XSTART);
		createEAttribute(sampleEClass, SAMPLE__XSTOP);
		createEAttribute(sampleEClass, SAMPLE__XSTEP);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getSample_X_start(), ecorePackage.getEDouble(), "x_start", "0", 0, 1, Sample.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSample_X_stop(), ecorePackage.getEDouble(), "x_stop", "1.0", 0, 1, Sample.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSample_X_step(), ecorePackage.getEDouble(), "x_step", "0.1", 0, 1, Sample.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
