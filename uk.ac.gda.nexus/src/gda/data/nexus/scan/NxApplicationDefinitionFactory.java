...
/**
 * Abstract superclass of NeXus application definition factory objects. An object of this type knows how to build a tree of NeXus base classes meeting an
 * application definition TODO: experimental code, do not commit
 *
 * @author mattdickie
 */
public interface NxApplicationDefinitionFactory {
	...
	/**
	 * TODO: which of these two methods (or perhaps both, for convenience) Add a link from the given location in the application definition to the given
	 * location in the main entry.
	 *
	 * @param fromPath
	 * @param toPath
	 */
	...
	/**
	 * Build the entry. TODO: it is theoretically possible for application definitions to have more than one root entry, although at present none do TODO: this
