 ...
 *
 */
public class PixiumStatusViewExecutableExtensionFactory implements FindableExecutableExtension {
	private final Logger logger = LoggerFactory.getLogger(PixiumStatusViewExecutableExtensionFactory.class);
