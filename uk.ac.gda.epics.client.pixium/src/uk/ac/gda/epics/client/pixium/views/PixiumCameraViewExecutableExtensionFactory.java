 ...
 *
 */
public class PixiumCameraViewExecutableExtensionFactory implements FindableExecutableExtension {

	private static final String PIXIUM_SUBSAMPLE_VIEW_NAME = "Pixium Subsample";
	private final Logger logger = LoggerFactory.getLogger(PixiumCameraViewExecutableExtensionFactory.class);
	private String viewPartName;
	private final static String PIXIUM_SUBSAMPLE_PLOT_VIEW_ID = "uk.ac.gda.beamline.client.pixiumsubsampleplot";
	...
	public Object create() throws CoreException {
		logger.info("creating the Pixium view");
		...
		cameraPreviewView.setSubsamplePlotViewName(PIXIUM_SUBSAMPLE_VIEW_NAME);
		cameraPreviewView.setSubsamplePlotViewId(PIXIUM_SUBSAMPLE_PLOT_VIEW_ID);
		logger.info("Pixium view created.");
