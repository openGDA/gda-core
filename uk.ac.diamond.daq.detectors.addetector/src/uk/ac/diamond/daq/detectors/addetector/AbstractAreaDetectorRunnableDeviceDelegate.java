 ...
 * }</pre>
 */
public abstract class AbstractAreaDetectorRunnableDeviceDelegate {

	private static final Logger logger = LoggerFactory.getLogger(AbstractAreaDetectorRunnableDeviceDelegate.class);

	AreaDetectorRunnableDeviceProxy runnableDeviceProxy;

	public AbstractAreaDetectorRunnableDeviceDelegate(AreaDetectorRunnableDeviceProxy runnableDeviceProxy) {
		this.runnableDeviceProxy = runnableDeviceProxy;
	}

	public AreaDetectorRunnableDeviceProxy getRunnableDeviceProxy() {
