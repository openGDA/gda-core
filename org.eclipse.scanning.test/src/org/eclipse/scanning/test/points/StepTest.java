 ...
 *
 */
class StepTest extends AbstractGeneratorTest {
	 ...
	 */
	@Test
	void testSizes() throws GeneratorException {
	 ...
	 */
	@Test
	void testDirectionSmaller() throws GeneratorException {
	 ...
	 */
	@Test
	void testTooLargeStep() throws GeneratorException {
	...
	@Test
	void testWithZeroLength() throws GeneratorException {
	...
	@Test
	void testWithZeroLengthAndNegativeStep() throws GeneratorException {
		AxialStepModel model = new AxialStepModel("Temperature", 0, 0, -1);
		IPointGenerator<AxialStepModel> gen = pointGeneratorService.createGenerator(model);
		GeneratorUtil.testGeneratorPoints(gen, 1);
		checkSequence(gen, 0);
	...
	@Test
	void testWithZeroStepAndLength() throws GeneratorException {
	 ...
	 */
	@Test
	void testStepAlmostTooLarge() throws GeneratorException {
	 ...
	 */
	@Test
	void testMisdirectedStepGenPoints() {
		assertThrows(GeneratorException.class,
				() -> pointGeneratorService.createGenerator(new AxialStepModel("Temperature", 290, 300, -1)));
	 ...
	 */
	@Test
	void testMisdirectedLengthGenPoints() {
		assertThrows(GeneratorException.class,
				() -> pointGeneratorService.createGenerator(new AxialStepModel("Temperature", 300, 290, 1)));
	}
	 ...
	 */
	@Test
	void testTolerance() throws GeneratorException {
	...
	@Test
	void testPerfectSequence() throws GeneratorException {
	...
	@Test
	void testImperfectSequence() throws GeneratorException {
	 ...
	 */
	@Test
	void testPowerIndependent() throws GeneratorException {
		for (int power : new int [] { 0, 1, 2, 3, 6, 9}) {
			...
			IPointGenerator<AxialStepModel> gen = pointGeneratorService.createGenerator(mmodel);
			GeneratorUtil.testGeneratorPoints(gen, 2);
