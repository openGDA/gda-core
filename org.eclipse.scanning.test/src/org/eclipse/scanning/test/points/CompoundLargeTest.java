...
class CompoundLargeTest extends AbstractGeneratorTest {

	@Test
	void test2Pow24() throws Exception {

		IPointGenerator<AxialStepModel> two = pointGeneratorService.createGenerator(new AxialStepModel("Temperature", 290,291,1));
		...
		IPointGenerator<CompoundModel> scan = pointGeneratorService.createCompoundGenerator(cModel);
		int size = scan.size();
