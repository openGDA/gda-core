...
class PauseTest extends BrokerTest {
	...
	@AfterEach
	void dispose() throws EventException {
	...
	@Test
	void testPausingAConsumerByID() throws Exception {
		...
		IPublisher<QueueCommandBean<?>> publisher = eventService.createPublisher(uri, EventConstants.CMD_TOPIC);
	...
	@Test
	void testPausingQueueByQueueName() throws Exception {
		...
		IPublisher<QueueCommandBean<?>> publisher = eventService.createPublisher(submitter.getUri(), EventConstants.CMD_TOPIC);
	...
	public void testReorderingAPausedQueue() throws Exception {
		...
		ISubscriber<EventListener> sub = eventService.createSubscriber(uri, jobQueue.getStatusTopicName());
	...
	public void testPauseResumeWhenScanRunning() throws Exception {
		...
		IPublisher<QueueCommandBean<?>> commandPublisher = eventService.createPublisher(submitter.getUri(), EventConstants.CMD_TOPIC);
