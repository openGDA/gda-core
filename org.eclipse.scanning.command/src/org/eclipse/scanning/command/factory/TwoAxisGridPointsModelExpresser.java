...
class TwoAxisGridPointsModelExpresser extends AbstractGridModelExpresser<TwoAxisGridPointsModel> {

	@Override
	public String pyExpress(TwoAxisGridPointsModel model, Collection<IROI> rois, boolean verbose) throws Exception {
