...
public enum DeviceState {
	...
	RESETTING,READY,EDITING,EDITABLE,SAVING,REVERTING,ARMED,CONFIGURING,RUNNING,POSTRUN,FINISHED,PAUSED,SEEKING,ABORTING,ABORTED,FAULT,DISABLING,DISABLED,OFFLINE;
