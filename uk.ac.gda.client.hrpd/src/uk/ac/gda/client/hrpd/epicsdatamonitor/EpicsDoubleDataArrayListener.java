 ...
 * 
 */
public class EpicsDoubleDataArrayListener implements MonitorListener, InitializationListener, Configurable, InitializingBean, Findable {
	...
	public EpicsDoubleDataArrayListener() {
