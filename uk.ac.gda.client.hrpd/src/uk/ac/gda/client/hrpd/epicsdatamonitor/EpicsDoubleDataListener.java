 ...
 * This listener stores a double data which updated via {@link MonitorEvent} from the EPICS PV by default,
 ...
 * 
 */
public class EpicsDoubleDataListener extends EpicsPVListener {
	private double value;
	private Logger logger=LoggerFactory.getLogger(EpicsDoubleDataListener.class);
	@Override
	...
	public Double getValue() {
		if (isPoll()) {
			try {
				return controller.cagetDoubleArray(pvchannel)[0];
