...
public class MbsNXDetectorTotalOnlyDataAppender implements NXDetectorDataAppender {

	private MbsAnalyserCompletedRegion region;

	public MbsNXDetectorTotalOnlyDataAppender(MbsAnalyserCompletedRegion region) {
		this.region = region;
	}

	@Override
	public void appendTo(NXDetectorData data, String detectorName) throws DeviceException {
		data.addData(detectorName, detectorName, new NexusGroupData(region.getTotalCount()), "counts");
		data.setPlottableValue(detectorName, region.getTotalCount());
