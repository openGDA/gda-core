 ...
 * factor.
 * <br>
 * This is almost an exact copy of {@code org.eclipse.draw2d.ScaledGraphics.ScaledGraphics} but with better
 * checks for scaled sizes to prevent GTK errors caused by trying to draw zero sized graphics.
 *
 */
public class ScaledGraphics extends Graphics {
	...
	public void drawRoundRectangle(Rectangle r, int arcWidth, int arcHeight) {
		Rectangle z = zoomRect(r.x, r.y, r.width, r.height);
		if (!z.isEmpty()) {
			graphics.drawRoundRectangle(z,
	...
	public void fillRoundRectangle(Rectangle r, int arcWidth, int arcHeight) {
		Rectangle z = zoomFillRect(r.x, r.y, r.width, r.height);
		if (z.isEmpty())
			return;
		graphics.fillRoundRectangle(z,
				(int) (arcWidth * zoom), (int) (arcHeight * zoom));
	}
