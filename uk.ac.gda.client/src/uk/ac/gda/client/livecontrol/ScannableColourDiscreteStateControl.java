...
import gda.rcp.views.ColourDiscreteStateComposite;

public class ScannableColourDiscreteStateControl extends LiveControlBase {

	private static final Logger logger = LoggerFactory.getLogger(ScannableColourDiscreteStateControl.class);
