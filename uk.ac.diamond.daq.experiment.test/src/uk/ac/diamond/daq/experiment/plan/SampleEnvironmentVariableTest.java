...
import uk.ac.diamond.daq.experiment.plan.SEVSignalSims;
import uk.ac.diamond.daq.experiment.plan.SampleEnvironmentVariable;
...
public class SampleEnvironmentVariableTest {
	...
	private class LatchSEVListener implements SEVListener {
		...
		private boolean await() throws InterruptedException {
			return latch.await(5, TimeUnit.MILLISECONDS);
		}
	}
