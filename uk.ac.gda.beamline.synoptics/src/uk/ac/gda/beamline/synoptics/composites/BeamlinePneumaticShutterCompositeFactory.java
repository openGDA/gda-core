...
public class BeamlinePneumaticShutterCompositeFactory implements CompositeFactory {
	...
	public Composite createComposite(Composite parent, int style) {
		return new BeamlinePneumaticShutterComposite(parent, style, parent.getDisplay(), label,
...
class BeamlinePneumaticShutterComposite extends Composite {
	private static final Logger logger = LoggerFactory.getLogger(BeamlinePneumaticShutterComposite.class);
	...
	public BeamlinePneumaticShutterComposite(Composite parent, int style, final Display display, String label,
