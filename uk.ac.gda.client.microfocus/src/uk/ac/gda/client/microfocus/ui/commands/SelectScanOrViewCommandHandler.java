...
public class SelectScanOrViewCommandHandler extends AbstractHandler implements IHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		try {
			if(HandlerUtil.getActivePart(event).getClass().equals(MicroFocusElementListView.class)){
				((MicroFocusElementListView)HandlerUtil.getActivePart(event)).toggleLoadMapForScan();
			}
			return Boolean.TRUE;
		} catch (Exception e) {
