...
public class Xspress3SystemBufferedDetector extends Xspress3System implements BufferedDetector {
    ...
    public Xspress3SystemBufferedDetector(Xspress3Controller controller, Timer tfg, DAServer daServer, int triggerSwitch) {
	super(tfg);
	...
	getDaServer().sendCommand(parameters.getNumberDataPoints() + " 0.000001 0.00000001 0 0 0 8");
	...
	return super.readFrames(startFrame, finalFrame);
    }

    @Override
    public NXDetectorData[] readAllFrames() throws DeviceException {
	return super.readFrames(0, controller.getNumFramesToAcquire());
    }
