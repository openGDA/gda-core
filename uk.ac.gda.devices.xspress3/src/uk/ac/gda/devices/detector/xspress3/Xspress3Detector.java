 ...
 * 
 */
public class Xspress3Detector extends DetectorBase implements Xspress3, FluorescenceAcquire {
	 ...
	 */
	public NexusTreeProvider[] readFrames(int firstFrame, int lastFrame) throws DeviceException {
