...
public class EpicsControllerPvProvider {
	...
	private static String FRAMES_PER_READ_SUFFIX = ":FRAME_COUNT_RBV";
...
//	private static String FILE_WRITE_STATUS = ":HDF5:WriteStatus";
	...
	private static String SCA_WIN1_SCAS_TEMPLATE = ":C%1d_SCA5_ARRAY_RBV.VAL";// channel (1-8)  this points towards a waveform
	private static String SCA_WIN2_SCAS_TEMPLATE = ":C%1d_SCA6_ARRAY_RBV.VAL";// channel (1-8)  this points towards a waveform
	
	private static String SCA_TIME_SCAS_TEMPLATE = ":C%1d_SCA0_ARRAY_RBV.VAL";// channel (1-8)  this points towards a waveform
	private static String SCA_RESET_TICKS_SCAS_TEMPLATE = ":C%1d_SCA1_ARRAY_RBV.VAL";// channel (1-8)  this points towards a waveform
	private static String SCA_RESET_COUNT_TEMPLATE = ":C%1d_SCA2_ARRAY_RBV.VAL";// channel (1-8)  this points towards a waveform
	private static String SCA_ALL_EVENT_TEMPLATE = ":C%1d_SCA3_ARRAY_RBV.VAL";// channel (1-8)  this points towards a waveform
	private static String SCA_ALL_GOOD_TEMPLATE = ":C%1d_SCA4_ARRAY_RBV.VAL";// channel (1-8)  this points towards a waveform
	private static String SCA_PILEUP_TEMPLATE = ":C%1d_SCA7_ARRAY_RBV.VAL";// channel (1-8)  this points towards a waveform
