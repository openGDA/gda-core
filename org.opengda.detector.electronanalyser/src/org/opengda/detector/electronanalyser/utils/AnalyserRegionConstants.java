...
public class AnalyserRegionConstants {

	private AnalyserRegionConstants() {}
	...
	public static final String EXTERNAL_IO = "external_io";

	public static final String DATA = "_data";

	public static final String IMAGE_DATA = IMAGE + DATA;
	public static final String SPECTRUM_DATA = SPECTRUM + DATA;
	public static final String EXTERNAL_IO_DATA = EXTERNAL_IO + DATA;
