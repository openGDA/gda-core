...
public class SequenceEditingDomain implements IEditingDomainProvider {
	...
	protected void initializeEditingDomain() {
		...
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap()
				.put(Resource.Factory.Registry.DEFAULT_EXTENSION, new RegiondefinitionResourceFactoryImpl());
		// Register the package to ensure it is available during loading.
		resourceSet.getPackageRegistry().put(RegiondefinitionPackage.eNS_URI, RegiondefinitionPackage.eINSTANCE);
	}
