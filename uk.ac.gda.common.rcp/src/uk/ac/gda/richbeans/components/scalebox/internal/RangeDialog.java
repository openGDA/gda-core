...
//		});
		...
		GridUtils.setVisibleAndLayout(singleValueLabel, false);
		...
		GridUtils.setVisibleAndLayout(rangeComposite, false);
		...
		GridUtils.setVisibleAndLayout(listEditor, false);
		listEditor.on();
	...
	protected void updateRangeType(DOEFieldType range, boolean setChoice) {
		...
		if (range==DOEFieldType.SINGLE_VALUE) {
			...
			GridUtils.setVisibleAndLayout(singleValueLabel, true);
			GridUtils.setVisibleAndLayout(rangeComposite,   false);
			GridUtils.setVisibleAndLayout(listEditor,       false);
			...
			GridUtils.setVisibleAndLayout(singleValueLabel, false);
			GridUtils.setVisibleAndLayout(rangeComposite,   false);
			GridUtils.setVisibleAndLayout(listEditor,       true);
			if (setChoice) rangeChoice.select(1);
			
		} else if (range==DOEFieldType.RANGE) {
			GridUtils.setVisibleAndLayout(singleValueLabel, false);
			GridUtils.setVisibleAndLayout(rangeComposite,   true);
			GridUtils.setVisibleAndLayout(listEditor,       false);
