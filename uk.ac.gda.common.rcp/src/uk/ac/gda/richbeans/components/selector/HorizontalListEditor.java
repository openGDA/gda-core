...
public final class HorizontalListEditor extends ListEditor {
	...
	public HorizontalListEditor(Composite parent, int style) {
		...
		add.setImage(SWTResourceManager.getImage(HorizontalListEditor.class, "add.png"));
		...
		delete.setImage(SWTResourceManager.getImage(HorizontalListEditor.class, "delete.png"));
		...
		man.add(new Action("Add", ResourceManager.getImageDescriptor(HorizontalListEditor.class, "add.png")) {
			@Override
			public void run() {
				addBean();
			}
		});
		man.add(new Action("Delete", ResourceManager.getImageDescriptor(HorizontalListEditor.class, "delete.png")) {
			@Override
			public void run() {
				deleteBean();
			}
