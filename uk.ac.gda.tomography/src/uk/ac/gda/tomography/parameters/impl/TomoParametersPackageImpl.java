...
public class TomoParametersPackageImpl extends EPackageImpl implements TomoParametersPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getDetectorProperties_AcquisitionTimeDivider(), ecorePackage.getEIntegerObject(), "acquisitionTimeDivider", "1", 1, 1, DetectorProperties.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
