...
public final class LogbackUtils {
	 ...
	 */
	public static void configureLoggingForProcess(String processName, List<String> configFiles, Map<String, String> properties) {
	...
	private static void refreshContext(String processName, List<String> configFiles, Map<String, String> properties) {
		LoggerContext context = getLoggerContext();
	 ...
	 * @throws IOException
	 */
	private static Set<File> configureLogging(LoggerContext context, List<String> configFiles) throws JoranException {
	 ...
	 * @param configFiles List of files to be included in configuration
	 * @return List of SaxEvents that would be generated by parsing an xml file that imported
	 *         all the configuration files.
	 */
	private static List<SaxEvent> mockMainLoggingFile(LoggerContext context, List<String> configFiles) {
		...
		for (var file: configFiles) {
			recorder.startElement("", "include", "include", attributes(Map.of("file", file)));
