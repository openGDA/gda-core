 ...
 * <ul>
 *   <li>{@link uk.ac.diamond.tomography.localtomo.QsubType#getProjectname <em>Projectname</em>}</li>
 *   <li>{@link uk.ac.diamond.tomography.localtomo.QsubType#getArgs <em>Args</em>}</li>
 *   <li>{@link uk.ac.diamond.tomography.localtomo.QsubType#getSinoqueue <em>Sinoqueue</em>}</li>
 *   <li>{@link uk.ac.diamond.tomography.localtomo.QsubType#getReconqueue <em>Reconqueue</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.diamond.tomography.localtomo.LocalTomoPackage#getQsubType()
...
public interface QsubType extends EObject {
	 ...
	 * @see uk.ac.diamond.tomography.localtomo.LocalTomoPackage#getQsubType_Projectname()
	...
	/**
	 * Sets the value of the '{@link uk.ac.diamond.tomography.localtomo.QsubType#getProjectname <em>Projectname</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setArgs(String)
	 * @see uk.ac.diamond.tomography.localtomo.LocalTomoPackage#getQsubType_Args()
	...
	/**
	 * Sets the value of the '{@link uk.ac.diamond.tomography.localtomo.QsubType#getArgs <em>Args</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.diamond.tomography.localtomo.LocalTomoPackage#getQsubType_Sinoqueue()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.NormalizedString"
	...
	/**
	 * Sets the value of the '{@link uk.ac.diamond.tomography.localtomo.QsubType#getSinoqueue <em>Sinoqueue</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see uk.ac.diamond.tomography.localtomo.LocalTomoPackage#getQsubType_Reconqueue()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.NormalizedString"
	...
	/**
	 * Sets the value of the '{@link uk.ac.diamond.tomography.localtomo.QsubType#getReconqueue <em>Reconqueue</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
