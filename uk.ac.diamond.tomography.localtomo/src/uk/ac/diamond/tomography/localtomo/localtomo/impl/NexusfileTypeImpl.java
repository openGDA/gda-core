 ...
 * <ul>
 *   <li>{@link uk.ac.diamond.tomography.localtomo.localtomo.impl.NexusfileTypeImpl#getShutterNXSPath <em>Shutter NXS Path</em>}</li>
 *   <li>{@link uk.ac.diamond.tomography.localtomo.localtomo.impl.NexusfileTypeImpl#getStagePosNXSPath <em>Stage Pos NXS Path</em>}</li>
 *   <li>{@link uk.ac.diamond.tomography.localtomo.localtomo.impl.NexusfileTypeImpl#getStageRotNXSPath <em>Stage Rot NXS Path</em>}</li>
 *   <li>{@link uk.ac.diamond.tomography.localtomo.localtomo.impl.NexusfileTypeImpl#getTifNXSPath <em>Tif NXS Path</em>}</li>
 *   <li>{@link uk.ac.diamond.tomography.localtomo.localtomo.impl.NexusfileTypeImpl#getImgkeyNXSPath <em>Imgkey NXS Path</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
