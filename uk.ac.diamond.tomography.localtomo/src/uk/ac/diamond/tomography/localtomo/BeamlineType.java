 ...
 * <ul>
 *   <li>{@link uk.ac.diamond.tomography.localtomo.BeamlineType#getIxx <em>Ixx</em>}</li>
 * </ul>
 * </p>
 *
 * @see uk.ac.diamond.tomography.localtomo.LocalTomoPackage#getBeamlineType()
...
public interface BeamlineType extends EObject {
	 ...
	 * @see #setIxx(IxxType)
	 * @see uk.ac.diamond.tomography.localtomo.LocalTomoPackage#getBeamlineType_Ixx()
	...
	/**
	 * Sets the value of the '{@link uk.ac.diamond.tomography.localtomo.BeamlineType#getIxx <em>Ixx</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
