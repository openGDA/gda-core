...
/**
 * TestSocketExecutor Class
 */
public class TestSocketExecutor implements SocketExecutor {
	
	private static final Logger logger = LoggerFactory.getLogger(TestSocketExecutor.class);
