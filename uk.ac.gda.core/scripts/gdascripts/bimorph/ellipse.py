import unittest
from math import sin, cos, pow, sqrt, ceil
...
class EllipseCalculator():
    def __init__(self, pixel_size=None, p_1=None, q_1=None, theta_1=None, p_2=None, q_2=None, theta_2=None, i_sign=None, detector_distance=None, slit_start=None, slit_end=None, slit_step=None, column=None):
        '''
