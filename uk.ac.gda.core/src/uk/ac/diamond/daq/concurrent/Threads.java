...
/**
 * ThreadFactory builder. Threads are daemon by default.<p>
 *
...
public final class Threads {
	...
	/**
	 * {@link ThreadFactory} builder to help creation of {@link ExecutorService}s. Instances should not be
	 * created directly but should be created using the {@link Threads} static methods instead.<p>
	 *
	 * @since 9.8
	 * @see ThreadFactory
	 * @see ExecutorService
	 */
	public static final class GdaThreadFactoryBuilder {
