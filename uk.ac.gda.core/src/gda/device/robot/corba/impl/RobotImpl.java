...
public class RobotImpl extends CorbaRobotPOA {
	 ...
	 */
	public void _delegate(Robot robot) {
		this.robot = robot;
	}
	...
	public Any getPosition() throws CorbaDeviceException {
		...
		try {
			java.lang.Object obj = robot.getPosition();
	...
	@Override
	public void clearSample() throws CorbaDeviceException {
		try {
			robot.clearSample();
		} catch (DeviceException e) {
			throw new CorbaDeviceException(e.getMessage());
	...
	@Override
	public String getError() throws CorbaDeviceException {
		try {
			return robot.getError();
		} catch (DeviceException e) {
			throw new CorbaDeviceException(e.getMessage());
		}
	}
	...
	@Override
	public void finish() throws CorbaDeviceException {
		try {
			robot.finish();
		} catch (DeviceException e) {
			throw new CorbaDeviceException(e.getMessage());
	...
	@Override
	public double getSamplePosition() throws CorbaDeviceException {
		try {
			return robot.getSamplePosition();
		} catch (DeviceException e) {
			throw new CorbaDeviceException(e.getMessage());
		}
	}
	...
	@Override
	public SampleState getSampleState() throws CorbaDeviceException {
		try {
			return SampleState.from_int(robot.getSampleState().value());
		} catch (DeviceException e) {
			throw new CorbaDeviceException(e.getMessage());
		}
	}
	...
	@Override
	public void next() throws CorbaDeviceException {
		try {
			robot.nextSample();
		} catch (DeviceException e) {
			throw new CorbaDeviceException(e.getMessage());
	...
	@Override
	public void nextSample(double n) throws CorbaDeviceException {
		try {
			robot.nextSample(n);
		} catch (DeviceException e) {
			throw new CorbaDeviceException(e.getMessage());
	...
	@Override
	public void recover() throws CorbaDeviceException {
		try {
			robot.recover();
		} catch (DeviceException e) {
			throw new CorbaDeviceException(e.getMessage());
	...
	public boolean isAt(Any arg0) throws CorbaDeviceException {
		try {
			return this.robot.isAt(arg0.extract_Value());
		} catch (DeviceException e) {
			throw new CorbaDeviceException(e.getMessage());
		}
	}
