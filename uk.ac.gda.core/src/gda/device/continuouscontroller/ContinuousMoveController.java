...
public interface ContinuousMoveController extends HardwareTriggerProvider {
	 ...
	 */
	void startMove() throws DeviceException;
	 ...
	 * @throws DeviceException
	 */
	boolean isMoving() throws DeviceException;

	/**
	 * Wait until the controller has completed moving axes
	 * @throws InterruptedException
	 */
	void waitWhileMoving() throws DeviceException, InterruptedException;
	 ...
	 * @throws InterruptedException
	 */
	void stopAndReset() throws DeviceException, InterruptedException;
}
