...
public class PolarimeterGridScan extends ScanBase implements Scan {
	...
	protected IPolarimeterPinholeEnumPositioner frontPinhole;
 ...
 */
	...
	protected void setupGridScan() {
		...
		if ((frontPinhole = (IPolarimeterPinholeEnumPositioner) Finder.getInstance().find("FrontPinholePositioner")) == null) {
