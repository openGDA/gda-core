...
public interface ComponentWriter {
	...
	public SelfCreatingLink makeComponent(NeXusFileInterface file, int[] dim, String path, String scannableName,
			String componentName, Object pos, String unit) throws NexusException;
