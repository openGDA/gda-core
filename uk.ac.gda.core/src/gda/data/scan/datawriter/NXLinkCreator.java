...
public class NXLinkCreator {
	...
	interface Visitor {
		 ...
		 * @throws Exception
		 */
		void arrive(String name, String nxClass) throws Exception;
	...
	private static void makelink(final NexusFileInterface file, String path, final NXlink link, final String url) throws Exception {
	...
	private static NXlink getLink(final NexusFileInterface file, String path) throws NexusException, Exception {
	...
	private static String getExternalLinkInfo(final NexusFileInterface file, String path, final String dataClassName, final String unavailable) throws NexusException, Exception {
		Visitor v = new Visitor() {
