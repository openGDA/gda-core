...
public class NXMetaDataProvider extends FindableBase implements NexusTreeAppender, Map<String, Object> {
	...
	public void appendToTopNode(INexusTree topNode) {
		...
		if (withScannables) {
			...
			Set<String> metaScannableSet = ServiceHolder.getNexusDataWriterConfiguration().getMetadataScannables();
...
//				System.out.println("getNexusTree: scannable = " + scn.getName());
	...
	public List<Scannable> getMetaScannables() {
		final List<Scannable> metaScannableList = new Vector<Scannable>();
