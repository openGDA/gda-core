 ...
 */
public class SimpleServletImpl extends CorbaDevicePOA {
	//
	 ...
	 */
	public SimpleServletImpl(FindableSimpleServlet findableServlet, org.omg.PortableServer.POA poa) {
		this.poa = poa;
		deviceImpl = new DeviceImpl(findableServlet, poa);
	}
