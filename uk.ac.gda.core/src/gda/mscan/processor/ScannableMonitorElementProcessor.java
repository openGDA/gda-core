...
public class ScannableMonitorElementProcessor extends ElementProcessorBase<Monitor> {

	public ScannableMonitorElementProcessor(Monitor source) {
		super(source);
	...
	public void process(final ClausesContext context,
		...
		if(isValidElement(context, this.getClass().getName(), Scannable.class)) {
			context.addMonitor(enclosed.getName(), false);
