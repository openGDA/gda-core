...
/**
 * This is the action bar contributor for the Scan model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScanActionBarContributor extends EditingDomainActionBarContributor
	...
	protected IAction refreshViewerAction = new Action(
			ScanEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) //$NON-NLS-1$
	{
		@Override
	 ...
	 * @generated
	 */
	public ScanActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("scan-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("scan-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				ScanEditorPlugin.INSTANCE.getString("_UI_ScanEditor_menu"), "uk.ac.gda.tomography.scanMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
