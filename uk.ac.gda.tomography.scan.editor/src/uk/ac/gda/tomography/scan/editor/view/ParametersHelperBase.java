 ...
 */
public class ParametersHelperBase {

	private static final Logger logger = LoggerFactory.getLogger(ParametersHelperBase.class);
	...
	protected ParametersHelperBase(Supplier<ScanningParameters> scanningParameterSupplier) {
		super();
	 ...
	 */
	protected void updateScanningParameters(ScanpathDocument.Builder builder) {
	...
	protected void updateTemplateData(List<ScannableTrackDocument> scannableTrackDocuments) {
		updateScanningParameters(getBuilder().withScannableTrackDocuments(scannableTrackDocuments));
	}
