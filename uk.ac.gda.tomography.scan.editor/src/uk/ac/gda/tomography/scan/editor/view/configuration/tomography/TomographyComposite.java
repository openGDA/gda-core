 ...
 */
public class TomographyComposite implements NamedCompositeFactory, ButtonControlledCompositeTemplate {
	...
	public TomographyComposite(Supplier<Composite> controlButtonsContainerSupplier) {
	...
	public CompositeFactory getControlledCompositeFactory() {
		if (acquistionConfigurationFactory == null) {
			this.acquistionConfigurationFactory = new TomographyScanControls();
		}
