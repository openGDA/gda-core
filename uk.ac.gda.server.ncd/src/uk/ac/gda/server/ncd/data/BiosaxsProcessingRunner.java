...
public class BiosaxsProcessingRunner extends ProcessingRunner implements Map<String, String> {
	...
	public void triggerProcessing(String... args) throws IOException {
		if (args.length != 3) {
			throw new IllegalArgumentException("Processing needs three arguments (file/background/collectionID");
		}
		String datafilepath = args[0];
		String backgroundfilepath = args[1];
		String dataCollectionId = args[2];
