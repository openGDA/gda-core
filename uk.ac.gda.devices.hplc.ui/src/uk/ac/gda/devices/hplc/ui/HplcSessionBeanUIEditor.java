...
public final class HplcSessionBeanUIEditor extends RichBeanEditorPart {

	private static final Logger logger = LoggerFactory.getLogger(HplcSessionBeanUIEditor.class);

	private HplcSessionBeanComposite beanComposite;

	public HplcSessionBeanUIEditor(String path, URL mappingURL, DirtyContainer dirtyContainer, Object editingBean) {
	...
	public void createPartControl(Composite comp) {
		...
		this.beanComposite = new HplcSessionBeanComposite(scrolledComposite, SWT.NONE, this);
