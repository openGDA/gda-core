...
class AxialStepCollatedIterator extends AxialStepIterator {

	public AxialStepCollatedIterator(AxialCollatedStepModel model, ScanPointIterator pyIterator) {
		super(model, pyIterator);
	}

	@Override
	protected AxialCollatedStepModel getModel() {
