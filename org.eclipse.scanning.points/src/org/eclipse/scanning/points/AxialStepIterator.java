 ...
 */
class AxialStepIterator extends SpgIterator {

	private final AxialStepModel model;

	public AxialStepIterator(AxialStepModel model, ScanPointIterator pyIterator) {
		super(pyIterator);
		this.model = model;
	}

	protected AxialStepModel getModel() {
		return model;
	}
