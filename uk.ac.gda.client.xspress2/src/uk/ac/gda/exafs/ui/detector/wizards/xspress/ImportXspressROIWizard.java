 ...
 */
public class ImportXspressROIWizard extends Wizard {
	...
	public ImportXspressROIWizard(int elementListSize, DetectorElementComposite detectorElementComposite, GridListEditor detectorList) {
		super();
