...
/**
 * For the @see {@link HardwareTriggeredWithOnlineDataReductionXmap} class to hold the ROIs.
 * <p>
 * This should be changed to a different ROI object when the xmap classes are refactored into a different plugin
 * (XAS-171)
 */
