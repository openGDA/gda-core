...
"""
 This file specifies common configuration settings for GDA Sphinx-generated documentation.

 It should be included in the conf.py for each document, as follows:
 ...
 Settings specific to a particular document should be specified in the conf.py for that document, after the execfile(conf_common_path)
"""
...
_author_diamond = u'Diamond Light Source'
latex_documents = []
...
"""
 Additional options for GDA and related projects
"""
