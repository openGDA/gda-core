...
/**
 * This is the item provider adapter for a {@link uk.ac.diamond.tomography.reconstruction.parameters.hm.ShapeType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ShapeTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ShapeType_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ShapeType_value_feature", "_UI_ShapeType_type"),
				 HmPackage.Literals.SHAPE_TYPE__VALUE,
				 true,
				 false,
				 false,
	...
	protected void addDonePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ShapeType_done_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ShapeType_done_feature", "_UI_ShapeType_type"),
				 HmPackage.Literals.SHAPE_TYPE__DONE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addInfoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ShapeType_info_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ShapeType_info_feature", "_UI_ShapeType_type"),
				 HmPackage.Literals.SHAPE_TYPE__INFO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((ShapeType)object).getValue();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ShapeType.class)) {
			case HmPackage.SHAPE_TYPE__VALUE:
			case HmPackage.SHAPE_TYPE__DONE:
			case HmPackage.SHAPE_TYPE__INFO:
