...
/**
 * This is the item provider adapter for a {@link uk.ac.diamond.tomography.reconstruction.parameters.hm.NameType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NameTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NameType_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NameType_value_feature", "_UI_NameType_type"),
				 HmPackage.Literals.NAME_TYPE__VALUE,
				 true,
				 false,
				 false,
	...
	protected void addInfoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NameType_info_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NameType_info_feature", "_UI_NameType_type"),
				 HmPackage.Literals.NAME_TYPE__INFO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((NameType)object).getValue();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NameType.class)) {
			case HmPackage.NAME_TYPE__VALUE:
			case HmPackage.NAME_TYPE__INFO:
