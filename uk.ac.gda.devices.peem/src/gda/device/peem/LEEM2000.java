...
/**
 * LEEM Elmitec PhotoEmission Electron Microscope class
 */
public class LEEM2000 extends DeviceBase implements PEEM {
	
	private static final Logger logger = LoggerFactory.getLogger(LEEM2000.class);

	ElmitecPEEM peem = null;
	...
	/**
	 * Construct a LEEM2000
	 * 
	 * @param ep
	 *            ElmitecPEEM object
	 */
	public LEEM2000(ElmitecPEEM ep) {
		peem = ep;
		// mc = ep.mc;
		msImpl = ep.msImpl;
		// connect();
