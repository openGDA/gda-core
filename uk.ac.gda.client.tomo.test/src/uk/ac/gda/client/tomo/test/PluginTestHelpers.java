...
public class PluginTestHelpers {
	...
	public static void openTomoPerspective(IUIContext ui) throws WidgetSearchException {
		IWidgetLocator widgetLocator = ui.click(new MenuItemLocator("Window/&Open Perspective/&Other..."));
	...
	public static void showConfigurationView(IUIContext ui) throws WidgetSearchException {
		IWidgetLocator widgetLocator = ui.click(new MenuItemLocator("Window/&Show View/Tomography Configuration"));


//		ui.click(new TableItemLocator("Tomography Configuration"));
//
//		ui.click(new ButtonLocator("OK"));
//
//		ui.wait(new PerspectiveLocator(TomographyPerspective.ID).isActive());
	...
	public static boolean isStreaming() {
		...
		Display.getDefault().syncExec(new Runnable() {
			...
			@Override
			public void run() {
				ViewerDisplayMode dm = ((TomoAlignmentView) PlatformUI.getWorkbench().getActiveWorkbenchWindow()
						.getActivePage().getActivePart()).getLeftWindowViewerDisplayMode();
				val[0] = dm == ViewerDisplayMode.FLAT_STREAM_LIVE || dm == ViewerDisplayMode.SAMPLE_STREAM_LIVE;
			}
		});
