...
package uk.ac.gda.epics.client;
 ...
 */
public class EPICSClientActivator extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "uk.ac.gda.epics.client"; //$NON-NLS-1$
